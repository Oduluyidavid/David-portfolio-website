      ...
      <div className="max-w-7xl mx-auto py-20 flex-flex-col md:flex-row justify-between">
        ...
        <div className="md:w-2/5 my-3">
          ...
          <p className="mt-5 text-sm leading-7 text-[#eee]">
            ...
            and web Applications that lead to the success of all overall
            products
          </p>
        </div>
        ...
        <div className="my-3">
          ...
          <div className="mt-5 flex gap-3">
            <a href="https://twitter.com/BankybennyD" target="blank" className="ml-1">
            ...
            <a href="https://www.instagram.com/davidadegokeoduluyi?igsh=MXAydzZubzJ2ZmNzeA%3D%3D&utm_source=qr" target="blank" className="ml-1">
              <img src={instagram} alt="" className="w-6 h-7" />
            </a>
            <a href="https://github.com/Oduluyidavid" target="blank" className="ml-1">
              <img src={github} alt="" className="w-7 h-7" />
            </a>
            <a href="https://wa.me/message/AOOQ35VVTML4D1" target="blank" className="ml-1">
